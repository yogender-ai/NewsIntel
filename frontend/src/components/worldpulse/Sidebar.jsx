import { Bell, Bookmark, Compass, Droplets, Home, Map, Orbit, Pencil, Search, Settings, ShieldQuestion, Star } from 'lucide-react';
  ...
  return (
    <aside className="wp-sidebar">
      ...
      <nav className="wp-nav">
        ...
        <a className="wp-nav-link" href="https://oil-pipeline.vercel.app" target="_blank" rel="noreferrer">
          <Droplets size={17} /> Current
        </a>
