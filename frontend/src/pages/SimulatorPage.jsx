...
export default function SimulatorPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      setRunMeta({ cached: Boolean(response.cached), runId: response.run_id });
    } catch (err) {
      ...
      <main className="world-pulse-main simulator-main">
        <header className="orbit-header ni-screen-header">
          <div>
            ...
            <p>Explore possible next steps using live signals, assumptions, and source-backed AI reasoning.</p>
          </div>
